...
export interface YoutubeRespons {
    kind:          string;
    etag:          string;
...
export class Convert {
    public static toYoutubeRespons(json: string): YoutubeRespons {
        return cast(JSON.parse(json), r("YoutubeRespons"));
    }

    public static youtubeResponsToJson(value: YoutubeRespons): string {
        return JSON.stringify(uncast(value, r("YoutubeRespons")), null, 2);
    }
}
